...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 6057a91c-5e2b-4064-9523-1cf4d164f44c
```

> `6057a91c-5e2b-4064-9523-1cf4d164f44c` is the password of the certificate, you can change it to any password you want.
